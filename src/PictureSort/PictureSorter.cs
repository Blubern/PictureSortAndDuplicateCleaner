...
public class PictureSorter
{
    ...
    private Task CheckForExistingFilesInTargetAsync(IReadOnlyList<FileInventoryResult> sourceDirectoryInventory, IReadOnlyList<FileInventoryResult> targetDirectoryInventory, string alreadyExistingFolder, IProgress<string> progress, CancellationToken cancellationToken)
    {
    ...
    private async Task MovePicturesToTheTargetFolderAsync(IReadOnlyList<FileInventoryResult> sourceDirectoryInventory, string targetFolder, IProgress<string> progress, int maxConcurrency, CancellationToken cancellationToken)
    {
